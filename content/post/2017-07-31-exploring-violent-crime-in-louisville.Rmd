...
raw_data <- read_rds("/data/lou_crime_geocoded_df.rds.gzip")
...
```{r violent_crime_trend_plot, echo = FALSE, cache = TRUE, out.width = '1100px', warning = FALSE, message = FALSE}
bar.theme <- 
...
If numbers are more your thing, you can see that violent crime is up about 5.7% from the 
12 year mean, but it is down slightly from the peak level which occured in 2007.
```{r violent_per_changes, echo = FALSE, cache = TRUE, out.width = '1100px', warning = FALSE, message = FALSE}
...
all_vio_changes <- all_vio_sum%>%
  mutate(crime_type = 'violent_crime',
...
```{r, daily_count_hist/dist, echo = FALSE, cache = TRUE, out.width = '1100px', warning = FALSE, message = FALSE}
hist.theme <- 
  theme(legend.position = "none")+
  theme(plot.title = element_text(size = 18, family = "serif", face = 'bold', hjust = 0, color = "#666666"))+
  theme(axis.title = element_text(size = 14, family = "serif", face = 'bold', hjust = 0, color = "#666666"))+
...
```{r, daily_count_all_years, echo = FALSE, cache = TRUE, out.width = '1100px', warning = FALSE, message = FALSE}
...
is visible.  
```{r, daily_count_all_vs_2015, echo = FALSE, cache = TRUE, out.width = '1100px', warning = FALSE, message = FALSE}
...
```{r,t_test_all_violent, echo = FALSE, cache = TRUE, out.width = '1100px', warning = FALSE, message = FALSE}
...
```{r crime_map1, echo = FALSE, cache = TRUE, out.width = "1100px", warning = FALSE, message = FALSE}
...
```{r crime_map2, echo = FALSE, cache = TRUE, out.width = "1100px", warning = FALSE, message = FALSE}
...
```{r zip_code_plot, echo = FALSE, cache = TRUE, out.width = "1100px", warning = FALSE, message = FALSE}
...
```{r worst_zip_codes, echo = FALSE, cache = TRUE, out.width = "1100px", warning = FALSE, message = FALSE}
bar.theme <- 
  theme(legend.position = "none")+
...
```{r 40211_exclusion, echo = FALSE, cache = TRUE, out.width = "1100px", warning = FALSE, message = FALSE}
bar.theme <- 
  theme(legend.position = "none")+
  theme(plot.title = element_text(size = 14, family = "serif", face = 'bold', hjust = 0, color = "#666666"))+
  theme(axis.title = element_text(size = 14, family = "serif", face = 'bold', hjust = 0, color = "#666666"))+
...
```{r t_test_no_40211, echo = FALSE, cache = TRUE, out.width = "1100px", warning = FALSE, message = FALSE}
t
```
...
The full code used to generate this report can be found [here](https://github.com/Grollus/LouisvilleCrime/blob/master/Exploring_Violent_Crime_in_Louisville.Rmd).