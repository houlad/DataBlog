...
```{r, increasing_drugs_bar_plot, echo = FALSE, cache = TRUE, warning = FALSE, message = FALSE, out.width = "100%"}
drug_offenses %>%
...
```{r, decreasing_drugs_bar_plot, echo = FALSE, cache = TRUE, warning = FALSE, message = FALSE, out.width = "100%"}
drug_offenses %>%
...
```{r,all_rec_drug_offenses, echo = FALSE, cache = TRUE, warning = FALSE, message = FALSE, out.width = "100%"}
drug_offenses %>%
  filter(year >= 2007)%>%
  group_by(year)%>%
  summarise(count = n())%>%
...
```{r, marijuana_v_heroin_bar, echo = FALSE, cache = TRUE, warning = FALSE, message = FALSE, out.width="100%"}
drug_offenses %>%
...
```{r overdose_bar_plot, echo = FALSE, cache = TRUE, warning = FALSE, message = FALSE, out.width = "100%"}
overdose%>%
  filter(year >= 2007)%>%
  ggplot(aes(x = year, y = count))+
...
```{r heroin_choropleth_multiples, echo = FALSE, cache = TRUE, warning = FALSE, message = FALSE, out.width = "100%"}
...
```{r normalized_heroin_use, echo = FALSE, message = FALSE, cache = TRUE, warning = FALSE, eval = FALSE, out.width = "100%"}
