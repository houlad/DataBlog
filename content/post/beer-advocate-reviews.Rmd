...
```{r, greater-20-abv-distribution, echo = FALSE}
reviews_raw%>%
  filter(!is.na(beer_abv), beer_abv > 20)%>%
  ggplot(aes(beer_abv))+
  geom_histogram(fill = "#0072B2", color = 'white', alpha = .8)+
...
```{r, less-20, abv distribution, echo = FALSE}
