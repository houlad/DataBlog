...
```{r create_new_variables, dependson = 'load_data'}
...
```{r basic_filtering, dependson = 'load_data', echo = FALSE}
...
```{r aggregation_and_time_series_creation, dependson = 'load_data'}
# Aggregate function
# Takes in 
...
```{r basic_timeseries, dependson= 'load_data', echo = FALSE, fig.align = 'center', fig.cap = 'Fig.1'}
...
```{r basic_yearly_plot, dependson = 'load_data', echo = FALSE, fig.align = 'center', fig.cap = 'Fig.2'}
thefts_yw %>%
  filter(year != 2017)%>%
  ...
  xlab("")+
  ylab("Theft Count")+
  labs(title = "Number of Thefts by Month, 2007-2016")+
  theme(plot.title = element_text(size = 18, family = "serif", face = 'bold', hjust = 0, color = "#666666"))+
  theme(axis.title = element_text(size = 14, family = "serif", face = 'bold', hjust = 0, color = "#666666"))
...
```{r naive_baselines, dependson= 'load_data', fig.align = 'center'}
...
```{r 2016_2017_comparison, dependson='load_data', echo = FALSE, fig.align = 'center', fig.cap = 'Fig.3'}
thefts_yw %>%
  filter(year >= 2016)%>%
  ggplot( aes(x = month, y = count, group = year, colour = year))+
  geom_line()+
  ...
  xlab("")+
  ylab("Theft Count")+
  labs(title = "Number of Thefts by Month, 2016 v 2017")+
  theme(plot.title = element_text(size = 18, family = "serif", face = 'bold', hjust = 0, color = "#666666"))+
  theme(axis.title = element_text(size = 14, family = "serif", face = 'bold', hjust = 0, color = "#666666"))
```
...
```{r decomposition_plot, dependson= 'load_data', fig.align = 'center', fig.cap = 'Fig.4'}
...
```{r lm_fit, dependson='load_data'}
fit.lm <- tslm(theft_train ~ season + trend)
fc.lm <- forecast(fit.lm, h = 6)
```

```{r create_plot, dependson='load_data', echo = FALSE, fig.align = 'center', fig.cap = 'Fig.5'}
...
ggplot(plot_df, aes(x = date, y = observed, col = 'black'))+
  ...
  xlab("")+
  ylab("Monthly Thefts")+
  labs(title = "Linear Model Observed v Fitted, 2007-2017")+
  theme(plot.title = element_text(size = 18, family = "serif", face = 'bold', hjust = 0, color = "#666666"))+
  theme(axis.title = element_text(size = 14, family = "serif", face = 'bold', hjust = 0, color = "#666666"))
```
...
```{r lm_accuracy, dependson= 'load_data', echo = FALSE}
...
```{r lm_residual_diagnostics, dependson= 'load_data', fig.align = 'center', fig.cap = 'Fig.6'}
...
```{r stationarity_check, dependson= 'load_data', fig.align = 'center', fig.cap = 'Fig.7'}
...
```{r stationary_data, dependson= 'load_data', fig.align='center', fig.cap = 'Fig.8'}
...
```{r adf_test, dependson= 'load_data', echo = FALSE}
...
```{r seasonal_diff_model, dependson='load_data', fig.align = 'center', fig.cap = 'Fig.9'}
...
```{r seasonal_diff_model_acc, dependson='load_data', echo = FALSE}
...
```{r seasonal_diff_model2, dependson='load_data', fig.align = 'center', fig.cap = 'Fig.10'}
...
```{r seasonal_diff_model2_acc, dependson='load_data', echo = FALSE}
...
```{r seasonal_diff_model3, dependson='load_data', fig.align = 'center', fig.cap = 'Fig.11'}
...
```{r seasonal_diff_model3_acc, dependson='load_data', echo = FALSE}
...
```{r final_arima_model, dependson= 'load_data', fig.align = 'center', fig.cap = 'Fig.12'}
...
```{r final_arima_model_acc, dependson='load_data', echo = FALSE}
...
```{r, ARIMA_forecast_plot, dependson= c('load_data','create_plot'), fig.align = 'center', fig.cap = 'Fig.13', echo = FALSE}
...
ggplot(arima_df, aes(x = date, y = observed, col = 'black'))+
  ...
  xlab("")+
  ylab("Monthly Thefts")+
  labs(title = "ARIMA Model Observed v Fitted, 2007-2017")+
  theme(plot.title = element_text(size = 18, family = "serif", face = 'bold', hjust = 0, color = "#666666"))+
  theme(axis.title = element_text(size = 14, family = "serif", face = 'bold', hjust = 0, color = "#666666"))
...
specifically, I have a bunch of exciting ideas I'd like to try in the future.  A particuarly exciting area is the use of Gaussian Processes to 
